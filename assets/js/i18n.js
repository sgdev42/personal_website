(function () {
  ...
  const MANUAL_TRANSLATIONS = [
    ["Simon Guo - software engineer focused on product-oriented development. View projects, skills, and contact details.", "Simon Guo - 专注产品导向开发的软件工程师。查看项目、技能与联系方式。"],
    ...
    ["I build product-focused web applications using JavaScript, TypeScript, and AI tooling.", "我使用 JavaScript、TypeScript 和 AI 工具构建产品导向的 Web 应用。"],
    ["Featured Work", "精选项目"],
    ["Built a responsive portfolio with runtime EN/ZH translation, clean architecture, and GitHub Pages deployment.", "构建了支持中英文运行时翻译、架构清晰并部署在 GitHub Pages 的响应式作品集网站。"],
    ["View Repo", "查看仓库"],
    ["Reserved for upcoming production work and case-study writeup.", "预留给即将上线的项目与案例总结。"],
    ["Reserved for an additional project relevant to hiring roles.", "预留给与求职岗位相关的后续项目。"],
    ["Short Intro", "简短介绍"],
    ["I enjoy building practical software that helps real users and teams move faster. I care about clean implementation, readable code, and shipping with clear product impact.", "我喜欢构建能帮助真实用户和团队提升效率的实用软件。我重视清晰实现、可读代码，以及具备明确产品价值的交付。"],
    ["Skills / Tech", "技能 / 技术栈"],
    ["Core Stack", "核心技术栈"],
    ["Let’s Connect", "欢迎联系"],
    ["If you are hiring for a software engineering role, I would love to connect and share how I can contribute.", "如果你正在招聘软件工程岗位，我很愿意沟通并分享我可以如何贡献。"],
    ["View Resume", "查看简历"],
    ["Email:", "邮箱："],
    ["Recruiter-focused personal site built for fast scanning and clear call-to-action paths.", "面向招聘方的个人网站，突出快速浏览体验与清晰的行动引导。"],
    ["Problem", "问题"],
    ["A basic portfolio was not converting visitors into interview conversations.", "基础作品集无法有效把访客转化为面试沟通。"],
    ["Solution", "解决方案"],
    ["Redesigned into a single-page narrative with clear CTA flow and bilingual support.", "重构为单页叙事结构，具备清晰 CTA 路径与中英文支持。"],
    ["Tech Stack", "技术栈"],
    ["Result", "结果"],
    ["Improved messaging clarity and created a scalable framework for future portfolio updates.", "提升了信息表达清晰度，并建立了可扩展的后续更新框架。"],
    ["Live", "在线预览"],
    ["GitHub", "GitHub"],
    ["Automation Utility (Template)", "自动化工具（模板）"],
    ["Placeholder project card to preserve reusable structure.", "用于保留可复用结构的占位项目卡片。"],
    ["Manual repetitive tasks slowed delivery speed and introduced errors.", "重复性的手动任务降低交付速度并增加错误率。"],
    ["Built a small automation script to standardize repeat workflows.", "构建了小型自动化脚本来标准化重复工作流。"],
    ["Learned how to reduce manual effort and improve repeatable developer workflows.", "学习了如何减少手动成本并提升开发流程可复用性。"],
    ["API Integration Project (Template)", "API 集成项目（模板）"],
    ["Placeholder card for future external-service integration work.", "用于未来外部服务集成工作的占位卡片。"],
    ["Needed a reliable way to combine external data into a usable product surface.", "需要一种可靠方式将外部数据整合到可用的产品界面中。"],
    ["Created a modular API layer with clear request, error, and response handling.", "构建模块化 API 层，清晰处理请求、错误与响应。"],
    ["Learned to design cleaner integration boundaries and more debuggable data pipelines.", "学习了如何设计更清晰的集成边界与更易调试的数据链路。"],
  ];
